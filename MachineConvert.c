...
// Thinking about this now, I don't know how it'll work out here if they use addresses that aren't within the normal range
// for example if they use an address that's inbetween the 32 entries (individual bytes for a specific non-word addition)
// It *will* break with the current logic, if I remember I'll ask about it.
...
int main() {
    // Initialize registers from project pdf
    rf[1] = 0x20;
    rf[2] = 0x5;
    rf[10] = 0x70;
    rf[11] = 0x4;
    // Initialize data memory from project pdf
